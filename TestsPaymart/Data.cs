...
public class Data:General
{
    ...
    protected string _buyerPnfl = "30902950200026";//"";
    protected string _passportNumber = "AA3869823";//"";
    protected string _buyerCard = "8600492920928161";//;
    protected string _buyerCardDate = "1226"; //;
    protected string _negativeBuyer = "8940937094";
    protected string _newBuyer = "8909831021"; //"8909831021";// 10 цифр
